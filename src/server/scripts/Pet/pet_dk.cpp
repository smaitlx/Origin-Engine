    ...
    public:
        ...
        struct npc_pet_dk_ebon_gargoyleAI : CasterAI
        {
            ...
            void InitializeAI() OVERRIDE
            {
                ...
                ORIGIN::AnyUnfriendlyUnitInObjectRangeCheck u_check(me, me, 30.0f);
                ORIGIN::UnitListSearcher<ORIGIN::AnyUnfriendlyUnitInObjectRangeCheck> searcher(me, targets, u_check);
