        ...
        struct npc_crok_scourgebaneAI : public npc_escortAI
        {
            ...
            void WaypointStart(uint32 waypointId) OVERRIDE
            {
                ...
                switch (waypointId)
                {
                    ...
                    case 4:
                    {
                        ...
                        ORIGIN::CreatureListSearcher<FrostwingVrykulSearcher> searcher(me, temp, check);
            ...
            void DamageTaken(Unit* /*attacker*/, uint32& damage) OVERRIDE
            {
                ...
                if (!_wipeCheckTimer)
                {
                    _wipeCheckTimer = 1000;
                    Player* player = NULL;
                    ORIGIN::AnyPlayerInObjectRangeCheck check(me, 60.0f);
                    ORIGIN::PlayerSearcher<ORIGIN::AnyPlayerInObjectRangeCheck> searcher(me, player, check);
                    ...
                    if (!player)
                    {
                        ...
                        if (damage >= me->GetHealth())
                        {
                            ...
                            ORIGIN::CreatureWorker<FrostwingGauntletRespawner> worker(me, respawner);
    ...
    public:
                ...
                while (uint32 eventId = Events.ExecuteEvent())
                {
                    switch (eventId)
                    {
                        ...
                        case EVENT_ARNATH_PW_SHIELD:
                        {
                            ...
                            DoCast(ORIGIN::Containers::SelectRandomContainerElement(targets), SPELL_POWER_WORD_SHIELD);
        ...
        private:
            Creature* FindFriendlyCreature() const
            {
                ...
                ORIGIN::MostHPMissingInRange u_check(me, 60.0f, 0);
                ORIGIN::CreatureLastSearcher<ORIGIN::MostHPMissingInRange> searcher(me, target, u_check);
    ...
    public:
        ...
        class spell_icc_sprit_alarm_SpellScript : public SpellScript
        {
            ...
            void HandleEvent(SpellEffIndex effIndex)
            {
                ...
                wards.sort(ORIGIN::ObjectDistanceOrderPred(GetCaster()));
    ...
    public:
        ...
        class spell_frost_giant_death_plague_SpellScript : public SpellScript
        {
            ...
            void FilterTargets(std::list<WorldObject*>& targets)
            {
                ...
                if (!targets.empty())
                {
                    WorldObject* target = ORIGIN::Containers::SelectRandomContainerElement(targets);
                    targets.clear();
    ...
    public:
        ...
        class spell_svalna_revive_champion_SpellScript : public SpellScript
        {
            ...
            void RemoveAliveTarget(std::list<WorldObject*>& targets)
            {
                ...
                ORIGIN::Containers::RandomResizeList(targets, 2);
            }
    ...
    public:
        ...
        bool OnTrigger(Player* player, AreaTriggerEntry const* /*areaTrigger*/) OVERRIDE
        {
            ...
            if (instance->GetData(DATA_COLDFLAME_JETS) == NOT_STARTED)
            {
                ...
                traps.sort(ORIGIN::ObjectDistanceOrderPred(player));
                bool instant = false;
