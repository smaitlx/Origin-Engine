/*
 * Copyright (C) 2008-2012 OriginEngine <http://www.OriginEngine.org/>
 *
    ...
    public:
        ...
        struct boss_voice_of_yogg_saronAI : public BossAI
        {
            ...
            void Reset() OVERRIDE
            {
                ...
                clouds.sort(ORIGIN::ObjectDistanceOrderPred(me, true));
    ...
    public:
        ...
        class spell_yogg_saron_psychosis_SpellScript : public SanityReduction
        {
            ...
            void FilterTargets(std::list<WorldObject*>& targets)
            {
                ...
                targets.remove_if(ORIGIN::UnitAuraCheck(true, SPELL_ILLUSION_ROOM));
            }
