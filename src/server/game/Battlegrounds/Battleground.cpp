...
namespace ORIGIN
{
    class BattlegroundChatBuilder
    {
        public:
            ...
            {
                char const* text = sObjectMgr->GetORIGINString(_textId, loc_idx);
                if (_args)
                {
    ...
    class Battleground2ChatBuilder
    {
        public:
            ...
            {
                char const* text = sObjectMgr->GetORIGINString(_textId, loc_idx);
                char const* arg1str = _arg1 ? sObjectMgr->GetORIGINString(_arg1, loc_idx) : "";
                char const* arg2str = _arg2 ? sObjectMgr->GetORIGINString(_arg2, loc_idx) : "";
...
uint32 Battleground::GetBonusHonorFromKill(uint32 kills) const
{
    ...
    return ORIGIN::Honor::hk_honor_at_level(maxLevel, float(kills));
}
...
void Battleground::SendMessageToAll(int32 entry, ChatMsg type, Player const* source)
{
    ...
    ORIGIN::BattlegroundChatBuilder bg_builder(type, entry, source);
    ORIGIN::LocalizedPacketDo<ORIGIN::BattlegroundChatBuilder> bg_do(bg_builder);
...
void Battleground::PSendMessageToAll(int32 entry, ChatMsg type, Player const* source, ...)
{
    ...
    ORIGIN::BattlegroundChatBuilder bg_builder(type, entry, source, &ap);
    ORIGIN::LocalizedPacketDo<ORIGIN::BattlegroundChatBuilder> bg_do(bg_builder);
    BroadcastWorker(bg_do);
...
void Battleground::SendWarningToAll(int32 entry, ...)
{
    ...
    char const* format = sObjectMgr->GetORIGINStringForDBCLocale(entry);
...
{
    ORIGIN::Battleground2ChatBuilder bg_builder(type, entry, source, arg1, arg2);
    ORIGIN::LocalizedPacketDo<ORIGIN::Battleground2ChatBuilder> bg_do(bg_builder);
    BroadcastWorker(bg_do);
}
...
// To be removed
char const* Battleground::GetORIGINString(int32 entry)
{
