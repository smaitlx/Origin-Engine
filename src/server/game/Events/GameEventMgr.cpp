...
void GameEventMgr::RunSmartAIScripts(uint16 event_id, bool activate)
{
    ...
    {
        ORIGIN_READ_GUARD(HashMapHolder<Creature>::LockType, *HashMapHolder<Creature>::GetLock());
    ...
    {
        ORIGIN_READ_GUARD(HashMapHolder<GameObject>::LockType, *HashMapHolder<GameObject>::GetLock());
