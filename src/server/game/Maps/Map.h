...
class MapInstanced;
class InstanceMap;
namespace ORIGIN { struct ObjectUpdater; }
...
class Map : public GridRefManager<NGridType>
{
    ...
    public:
        ...
        void VisitNearbyCellsOf(WorldObject* obj, TypeContainerVisitor<ORIGIN::ObjectUpdater, GridTypeMapContainer> &gridVisitor, TypeContainerVisitor<ORIGIN::ObjectUpdater, WorldTypeMapContainer> &worldVisitor);
        ...
        {
            return IsGridLoaded(ORIGIN::ComputeGridCoord(x, y));
        }
