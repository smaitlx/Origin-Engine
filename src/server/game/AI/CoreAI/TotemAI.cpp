...
void TotemAI::UpdateAI(uint32 /*diff*/)
{
    ...
    {
        victim = NULL;
        ORIGIN::NearestAttackableUnitInObjectRangeCheck u_check(me, me, max_range);
        ORIGIN::UnitLastSearcher<ORIGIN::NearestAttackableUnitInObjectRangeCheck> checker(me, victim, u_check);
