...
std::list<Creature*> ScriptedAI::DoFindFriendlyCC(float range)
{
    ...
    ORIGIN::CreatureListSearcher<ORIGIN::FriendlyCCedInRange> searcher(me, list, u_check);
    me->VisitNearbyObject(range, searcher);
...
{
    std::list<Creature*> list;
    ORIGIN::FriendlyMissingBuffInRange u_check(me, range, uiSpellid);
...
Player* ScriptedAI::GetPlayerAtMinimumRange(float minimumRange)
{
    ...
    CellCoord pair(ORIGIN::ComputeCellCoord(me->GetPositionX(), me->GetPositionY()));
    Cell cell(pair);
    cell.SetNoCreate();

    ORIGIN::PlayerAtMinimumRangeAway check(me, minimumRange);
    ORIGIN::PlayerSearcher<ORIGIN::PlayerAtMinimumRangeAway> searcher(me, player, check);
    TypeContainerVisitor<ORIGIN::PlayerSearcher<ORIGIN::PlayerAtMinimumRangeAway>, GridTypeMapContainer> visitor(searcher);
