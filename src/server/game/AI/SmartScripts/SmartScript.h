...
#ifndef ORIGIN_SMARTSCRIPT_H
#define ORIGIN_SMARTSCRIPT_H
...
class SmartScript
{
    public:
        ...
        Creature* FindCreatureNear(WorldObject* searchObject, uint32 guid) const
        {
            ...
            ORIGIN::CreatureWithDbGUIDCheck target_check(searchObject, guid);
            ORIGIN::CreatureSearcher<ORIGIN::CreatureWithDbGUIDCheck> checker(searchObject, creature, target_check);
