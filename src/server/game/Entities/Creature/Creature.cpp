...
void Creature::DoFleeToGetAssistance()
{
    ...
    if (radius >0)
    {
        ...
        Cell cell(p);
        cell.SetNoCreate();
        ORIGIN::NearestAssistCreatureInCreatureRangeCheck u_check(this, GetVictim(), radius);
        ORIGIN::CreatureLastSearcher<ORIGIN::NearestAssistCreatureInCreatureRangeCheck> searcher(this, creature, u_check);

        TypeContainerVisitor<ORIGIN::CreatureLastSearcher<ORIGIN::NearestAssistCreatureInCreatureRangeCheck>, GridTypeMapContainer > grid_creature_searcher(searcher);
...
Unit* Creature::SelectNearestTarget(float dist) const
{
...

    {
        ...
        ORIGIN::NearestHostileUnitCheck u_check(this, dist);
        ORIGIN::UnitLastSearcher<ORIGIN::NearestHostileUnitCheck> searcher(this, target, u_check);

        TypeContainerVisitor<ORIGIN::UnitLastSearcher<ORIGIN::NearestHostileUnitCheck>, WorldTypeMapContainer > world_unit_searcher(searcher);
        TypeContainerVisitor<ORIGIN::UnitLastSearcher<ORIGIN::NearestHostileUnitCheck>, GridTypeMapContainer >  grid_unit_searcher(searcher);
...
Unit* Creature::SelectNearestTargetInAttackDistance(float dist) const
{
    ...
    {
        ORIGIN::NearestHostileUnitInAttackDistanceCheck u_check(this, dist);
        ORIGIN::UnitLastSearcher<ORIGIN::NearestHostileUnitInAttackDistanceCheck> searcher(this, target, u_check);

        TypeContainerVisitor<ORIGIN::UnitLastSearcher<ORIGIN::NearestHostileUnitInAttackDistanceCheck>, WorldTypeMapContainer > world_unit_searcher(searcher);
        TypeContainerVisitor<ORIGIN::UnitLastSearcher<ORIGIN::NearestHostileUnitInAttackDistanceCheck>, GridTypeMapContainer >  grid_unit_searcher(searcher);
...
Player* Creature::SelectNearestPlayer(float distance) const
{
    ...
    ORIGIN::NearestPlayerInObjectRangeCheck checker(this, distance);
    ORIGIN::PlayerLastSearcher<ORIGIN::NearestPlayerInObjectRangeCheck> searcher(this, target, checker);
    ...
    if (!m_AlreadyCallAssistance && GetVictim() && !IsPet() && !IsCharmed())
    {
        ...
        if (radius > 0)
        {
...

            {
                ...
                ORIGIN::AnyAssistCreatureInRangeCheck u_check(this, GetVictim(), radius);
                ORIGIN::CreatureListSearcher<ORIGIN::AnyAssistCreatureInRangeCheck> searcher(this, assistList, u_check);

                TypeContainerVisitor<ORIGIN::CreatureListSearcher<ORIGIN::AnyAssistCreatureInRangeCheck>, GridTypeMapContainer >  grid_creature_searcher(searcher);
...
void Creature::CallForHelp(float radius)
{
    ...
    ORIGIN::CallOfHelpCreatureInRangeDo u_do(this, GetVictim(), radius);
    ORIGIN::CreatureWorker<ORIGIN::CallOfHelpCreatureInRangeDo> worker(this, u_do);

    TypeContainerVisitor<ORIGIN::CreatureWorker<ORIGIN::CallOfHelpCreatureInRangeDo>, GridTypeMapContainer >  grid_creature_searcher(worker);
...
void Creature::SetPosition(float x, float y, float z, float o)
{
    ...
    if (!ORIGIN::IsValidMapCoord(x, y, z, o))
    {
...
Unit* Creature::SelectNearestHostileUnitInAggroRange(bool useLOS) const
{
    ...
    {
        ORIGIN::NearestHostileUnitInAggroRangeCheck u_check(this, useLOS);
        ORIGIN::UnitSearcher<ORIGIN::NearestHostileUnitInAggroRangeCheck> searcher(this, target, u_check);
