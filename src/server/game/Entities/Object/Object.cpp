...
void WorldObject::GetRandomPoint(const Position &pos, float distance, float &rand_x, float &rand_y, float &rand_z) const
{
    ...
    ORIGIN::NormalizeMapCoord(rand_x);
    ORIGIN::NormalizeMapCoord(rand_y);
...
{
    return ORIGIN::IsValidMapCoord(m_positionX, m_positionY, m_positionZ, m_orientation);
}
...
namespace ORIGIN
{
    class MonsterChatBuilder
    {
        public:
            ...
            {
                char const* text = sObjectMgr->GetORIGINString(i_textId, loc_idx);
...
{
    CellCoord p = ORIGIN::ComputeCellCoord(GetPositionX(), GetPositionY());

    Cell cell(p);
    cell.SetNoCreate();

    ORIGIN::MonsterCustomChatBuilder say_build(*this, CHAT_MSG_MONSTER_SAY, text, language, TargetGuid);
    ORIGIN::LocalizedPacketDo<ORIGIN::MonsterCustomChatBuilder> say_do(say_build);
    ORIGIN::PlayerDistWorker<ORIGIN::LocalizedPacketDo<ORIGIN::MonsterCustomChatBuilder> > say_worker(this, sWorld->getFloatConfig(CONFIG_LISTEN_RANGE_SAY), say_do);
    TypeContainerVisitor<ORIGIN::PlayerDistWorker<ORIGIN::LocalizedPacketDo<ORIGIN::MonsterCustomChatBuilder> >, WorldTypeMapContainer > message(say_worker);
...
void WorldObject::MonsterSay(int32 textId, uint32 language, uint64 TargetGuid)
{
    ...
    ORIGIN::MonsterChatBuilder say_build(*this, CHAT_MSG_MONSTER_SAY, textId, language, TargetGuid);
    ORIGIN::LocalizedPacketDo<ORIGIN::MonsterChatBuilder> say_do(say_build);
    ORIGIN::PlayerDistWorker<ORIGIN::LocalizedPacketDo<ORIGIN::MonsterChatBuilder> > say_worker(this, sWorld->getFloatConfig(CONFIG_LISTEN_RANGE_SAY), say_do);
    TypeContainerVisitor<ORIGIN::PlayerDistWorker<ORIGIN::LocalizedPacketDo<ORIGIN::MonsterChatBuilder> >, WorldTypeMapContainer > message(say_worker);
    cell.Visit(p, message, *GetMap(), *this, sWorld->getFloatConfig(CONFIG_LISTEN_RANGE_SAY));
}
...
void WorldObject::MonsterYell(const char* text, uint32 language, uint64 TargetGuid)
{
    ...
    ORIGIN::MonsterCustomChatBuilder say_build(*this, CHAT_MSG_MONSTER_YELL, text, language, TargetGuid);
    ORIGIN::LocalizedPacketDo<ORIGIN::MonsterCustomChatBuilder> say_do(say_build);
    ORIGIN::PlayerDistWorker<ORIGIN::LocalizedPacketDo<ORIGIN::MonsterCustomChatBuilder> > say_worker(this, sWorld->getFloatConfig(CONFIG_LISTEN_RANGE_YELL), say_do);
    TypeContainerVisitor<ORIGIN::PlayerDistWorker<ORIGIN::LocalizedPacketDo<ORIGIN::MonsterCustomChatBuilder> >, WorldTypeMapContainer > message(say_worker);
...
void WorldObject::MonsterYell(int32 textId, uint32 language, uint64 TargetGuid)
{
    ...
    ORIGIN::MonsterChatBuilder say_build(*this, CHAT_MSG_MONSTER_YELL, textId, language, TargetGuid);
    ORIGIN::LocalizedPacketDo<ORIGIN::MonsterChatBuilder> say_do(say_build);
    ORIGIN::PlayerDistWorker<ORIGIN::LocalizedPacketDo<ORIGIN::MonsterChatBuilder> > say_worker(this, sWorld->getFloatConfig(CONFIG_LISTEN_RANGE_YELL), say_do);
    TypeContainerVisitor<ORIGIN::PlayerDistWorker<ORIGIN::LocalizedPacketDo<ORIGIN::MonsterChatBuilder> >, WorldTypeMapContainer > message(say_worker);
    cell.Visit(p, message, *GetMap(), *this, sWorld->getFloatConfig(CONFIG_LISTEN_RANGE_YELL));
}
...
void WorldObject::MonsterTextEmote(int32 textId, uint64 TargetGuid, bool IsBossEmote)
{
    ...
    ORIGIN::MonsterChatBuilder say_build(*this, IsBossEmote ? CHAT_MSG_RAID_BOSS_EMOTE : CHAT_MSG_MONSTER_EMOTE, textId, LANG_UNIVERSAL, TargetGuid);
    ORIGIN::LocalizedPacketDo<ORIGIN::MonsterChatBuilder> say_do(say_build);
    ORIGIN::PlayerDistWorker<ORIGIN::LocalizedPacketDo<ORIGIN::MonsterChatBuilder> > say_worker(this, sWorld->getFloatConfig(CONFIG_LISTEN_RANGE_TEXTEMOTE), say_do);
    TypeContainerVisitor<ORIGIN::PlayerDistWorker<ORIGIN::LocalizedPacketDo<ORIGIN::MonsterChatBuilder> >, WorldTypeMapContainer > message(say_worker);
...
void WorldObject::MonsterWhisper(int32 textId, uint64 receiver, bool IsBossWhisper)
{
    ...
    LocaleConstant loc_idx = player->GetSession()->GetSessionDbLocaleIndex();
    char const* text = sObjectMgr->GetORIGINString(textId, loc_idx);
...
{
    ORIGIN::MessageDistDeliverer notifier(this, data, dist);
    VisitNearbyWorldObject(dist, notifier);
}

void WorldObject::SendMessageToSet(WorldPacket* data, Player const* skipped_rcvr)
{
    ORIGIN::MessageDistDeliverer notifier(this, data, GetVisibilityRange(), false, skipped_rcvr);
...
Creature* WorldObject::FindNearestCreature(uint32 entry, float range, bool alive) const
{
    ...
    ORIGIN::NearestCreatureEntryWithLiveStateInObjectRangeCheck checker(*this, entry, alive, range);
    ORIGIN::CreatureLastSearcher<ORIGIN::NearestCreatureEntryWithLiveStateInObjectRangeCheck> searcher(this, creature, checker);
...
{
    GameObject* go = NULL;
    ORIGIN::NearestGameObjectEntryInObjectRangeCheck checker(*this, entry, range);
    ORIGIN::GameObjectLastSearcher<ORIGIN::NearestGameObjectEntryInObjectRangeCheck> searcher(this, go, checker);
...
{
    GameObject* go = NULL;
    ORIGIN::NearestGameObjectTypeInObjectRangeCheck checker(*this, type, range);
    ORIGIN::GameObjectLastSearcher<ORIGIN::NearestGameObjectTypeInObjectRangeCheck> searcher(this, go, checker);
    VisitNearbyGridObject(range, searcher);
    return go;
}
...
{
    CellCoord pair(ORIGIN::ComputeCellCoord(this->GetPositionX(), this->GetPositionY()));
    Cell cell(pair);
    cell.SetNoCreate();

    ORIGIN::AllGameObjectsWithEntryInRange check(this, entry, maxSearchRange);
    ORIGIN::GameObjectListSearcher<ORIGIN::AllGameObjectsWithEntryInRange> searcher(this, gameobjectList, check);
    TypeContainerVisitor<ORIGIN::GameObjectListSearcher<ORIGIN::AllGameObjectsWithEntryInRange>, GridTypeMapContainer> visitor(searcher);
...
void WorldObject::GetCreatureListWithEntryInGrid(std::list<Creature*>& creatureList, uint32 entry, float maxSearchRange) const
{
    ...
    ORIGIN::AllCreaturesOfEntryInRange check(this, entry, maxSearchRange);
    ORIGIN::CreatureListSearcher<ORIGIN::AllCreaturesOfEntryInRange> searcher(this, creatureList, check);
    TypeContainerVisitor<ORIGIN::CreatureListSearcher<ORIGIN::AllCreaturesOfEntryInRange>, GridTypeMapContainer> visitor(searcher);
...
void WorldObject::GetNearPoint2D(float &x, float &y, float distance2d, float absAngle) const
{
    ...
    ORIGIN::NormalizeMapCoord(x);
    ORIGIN::NormalizeMapCoord(y);
}
...
void WorldObject::GetNearPoint(WorldObject const* /*searcher*/, float &x, float &y, float &z, float searcher_size, float distance2d, float absAngle) const
{
    ...
    // adding used positions around object
    {
        ...
        ORIGIN::NearUsedPosDo u_do(*this, searcher, absAngle, selector);
        ORIGIN::WorldObjectWorker<ORIGIN::NearUsedPosDo> worker(this, u_do);

        TypeContainerVisitor<ORIGIN::WorldObjectWorker<ORIGIN::NearUsedPosDo>, GridTypeMapContainer  > grid_obj_worker(worker);
        TypeContainerVisitor<ORIGIN::WorldObjectWorker<ORIGIN::NearUsedPosDo>, WorldTypeMapContainer > world_obj_worker(worker);
...
void WorldObject::MovePosition(Position &pos, float dist, float angle)
{
    ...
    if (!ORIGIN::IsValidMapCoord(destx, desty, pos.m_positionZ))
    {
    ...
    ORIGIN::NormalizeMapCoord(pos.m_positionX);
    ORIGIN::NormalizeMapCoord(pos.m_positionY);
...
void WorldObject::MovePositionToFirstCollision(Position &pos, float dist, float angle)
{
    ...
    // Prevent invalid coordinates here, position is unchanged
    if (!ORIGIN::IsValidMapCoord(destx, desty))
    {
...
void WorldObject::DestroyForNearbyPlayers()
{
    ...
    ORIGIN::AnyPlayerInObjectRangeCheck check(this, GetVisibilityRange(), false);
    ORIGIN::PlayerListSearcher<ORIGIN::AnyPlayerInObjectRangeCheck> searcher(this, targets, check);
...
void WorldObject::UpdateObjectVisibility(bool /*forced*/)
{
    ...
    ORIGIN::VisibleChangesNotifier notifier(*this);
    VisitNearbyWorldObject(GetVisibilityRange(), notifier);
}
